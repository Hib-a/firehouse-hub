      ...
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-4">
        <div>
          ...
          <div className="mt-5 flex gap-3">
            <a href="#" aria-label="Facebook" className="rounded-md p-2 text-white/70 hover:bg-white/10 hover:text-white"><Facebook className="h-4 w-4" /></a>
            <a href="#" aria-label="Instagram" className="rounded-md p-2 text-white/70 hover:bg-white/10 hover:text-white"><Instagram className="h-4 w-4" /></a>
            <a href="#" aria-label="Twitter" className="rounded-md p-2 text-white/70 hover:bg-white/10 hover:text-white"><Twitter className="h-4 w-4" /></a>
          </div>
        </div>

        <div>
          <h4 className="text-xs font-bold tracking-[0.15em] text-[var(--brass)] uppercase">Explore</h4>
          <ul className="mt-4 space-y-2 text-sm">
            ...
            <li><Link to="/recruitment" className="text-white/80 hover:text-white">Recruitment</Link></li>
            <li><Link to="/contact" className="text-white/80 hover:text-white">Contact</Link></li>
          </ul>
        </div>

        <div>
          <h4 className="text-xs font-bold tracking-[0.15em] text-[var(--brass)] uppercase">Station 7</h4>
          <address className="mt-4 space-y-2 text-sm text-white/80 not-italic">
            <div>1923 Liberty Avenue</div>
            <div>Ridgemont, RG 04108</div>
            <div className="pt-2"><a href="tel:5550117000" className="hover:text-white">(555) 011-7000</a></div>
            <div><a href="mailto:info@ridgemontfire.gov" className="hover:text-white">info@ridgemontfire.gov</a></div>
          </address>
        </div>

        <div>
          <h4 className="text-xs font-bold tracking-[0.15em] text-[var(--brass)] uppercase">Emergency</h4>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-start justify-between gap-2 px-4 py-5 text-xs text-white/60 sm:flex-row sm:items-center">
          ...
          <div className="flex items-center gap-4">
            <Link to="/auth" className="hover:text-white">Staff Login</Link>
            <span>·</span>
